...
git fetch https://github.com/AOSP-whatever/platform_bootable_recovery hos-rika --depth=2 -j64
git cherry-pick 573571cb77d4d69ae720169acd22c1aca336b5ea
popd

enter_aosp_dir build/make
git fetch https://github.com/AOSP-whatever/platform_build_make hos-rika --depth=8 -j64
...
git fetch https://github.com/AOSP-whatever/platform_build_soong hos-rika --depth=3 -j64
...
git fetch https://github.com/AOSP-whatever/platform_external_tinycompress android-11.0.0 --depth=2 -j64
...
git fetch https://github.com/AOSP-whatever/platform_frameworks_base hos-rika --depth=14 -j64
...
git fetch https://github.com/AOSP-whatever/platform_hardware_interfaces hos-rika --depth=3 -j64
git cherry-pick b49270a8347134826a50baddc699b0b02849782e
popd

enter_aosp_dir packages/apps/Settings
git fetch https://github.com/AOSP-whatever/platform_packages_apps_Settings hos-rika --depth=4 -j64
...
git fetch https://github.com/AOSP-whatever/platform_system_core hos-rika --depth=3 -j64
...
git fetch https://github.com/AOSP-whatever/platform_system_sepolicy hos-rika --depth=2 -j64
